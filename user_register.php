...
if (isset($_POST["submit"])){
    ...
    if ($_POST["email"] == ""){
        ...
        $erremail = "*hanya boleh angka dan huruf";
    } else {
        $erremail = "";
        $valid++;
    ...
    } elseif (!preg_match( "/^[0-9]*$/", $_POST["no_hp"])){ 
...
<body>
    ...
    <div class="container">
        ...
        <!-- form register -->
        <form action="user_register.php" enctype="multipart/form-data" method="post" >
            ...
            <input type="button" class="Back-Login" onclick="location.href='user_login.php'" value="Back to Login" />
